...
<script>
	...
	if(confirm('Apakah Anda yakin hapus?')) {
	    location.href='<?php echo ADMIN_ADDR."/hapus_users.php?id=" ?>'+a;    
	}
...
<table width="938" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="214" valign="middle"><font size="3" face="Times New Roman, Times, serif" color="#000000"><div align="center"><strong>Users</strong></div></td>
