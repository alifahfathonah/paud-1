...
$query_n = "SELECT Id_Karyawan,Nama,Alamat,Ttl,No_telp,devisi FROM karyawan";
	...
	<td width="8%">
	  ...
	  <form>
	    <input type=submit value=Refresh>
          ...
          <p>Silahkan Pilih Id Karyawan dan Klik tombol Pensil Untuk  Tambah Nilai ... ! <br>
          </p>
           <table width="100%" height="106" border="0" align="center" cellpadding=3 cellspacing=1>
<tr >
    <td  height="25" colspan="8" valign="middle"><font size="3" face="Times New Roman, Times, serif" color="#000000"><br><div align="center">
      <p><strong>Tambah Nilai Karyawan </strong></p>
      <p>&nbsp;</p>
    </div></td>
  </tr>
      <tr bgcolor=#cccccc height=20>
        ...
        <td><div align="center"><font size="3" face="Times New Roman, Times, serif" color="#000000">Tambah Nilai</div></td>
 ...
 <tr bgcolor=#cccccc>
    ...
    ?>
       <tr align=center bgcolor=<?php echo $bg;?> onMouseOver="this.style.backgroundColor='#dedede'" onMouseOut="this.style.backgroundColor='<?php echo $bg;?>'">
          ...
          <td><div align="center"><a href="penilaian.php?id=<?php echo $row_n['Id_Karyawan']; ?>"><img src="images/edit.png" width="16" height="16" border="0"></a></div></td>
