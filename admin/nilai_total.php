...
<tr >
    <td  height="25" colspan="10" valign="middle"><font size="3" face="Times New Roman, Times, serif" color="#000000"><br><div align="center"><strong>Tabel Master Data Karyawan </strong></div><br></td>
      ...
      <tr bgcolor=#cccccc height=20>
        ...
        <td><div align="center"><font size="3" face="Times New Roman, Times, serif" color="#000000">Total Nilai</div></td>
        <td><div align="center"><font size="3" face="Times New Roman, Times, serif" color="#000000">Keputusan Prestasi</div></td>
      </tr>
 <tr bgcolor=#cccccc>
	...
	switch ($rumus) {
	case 1 : $x = 0.23; $y = 0.093; $z = 0.143; $f = 0.216; $s = 0.15; $r = 0.16; break;
	case 2 : $x = 0.23; $y = 0.093; $z = 0.143; $f = 0.216; $s = 0.15; $r = 0.16; break;
	case 3 : $x = 0.23; $y = 0.093; $z = 0.143; $f = 0.216; $s = 0.15; $r = 0.16; break;	
	}
      $i = 0;
     do { 
		$angka = ceil(($row_n['loyalitas']*$x) + ($row_n['disiplin']*$y) + ($row_n['hubungan']*$z) + ($row_n['tanggungjawab']*$f)
		+ ($row_n['kepemimpinan']*$s) + ($row_n['prestasi']*$r) );
		if ($angka >= 80)
			$huruf = "Prestasi Sangat Terbaik";
		elseif ($angka >= 68)
			$huruf = "Prestasi Terbaik";
		elseif ($angka >= 59)
			$huruf = "Prestasi Baik";
		elseif ($angka >= 49)
			$huruf = "Prestasi Cukup";
    ...
    ?>
       <tr align=center bgcolor=<?php echo $bg;?> onMouseOver="this.style.backgroundColor='#dedede'" onMouseOut="this.style.backgroundColor='<?php echo $bg;?>'">
          ...
          <td><font size="3" face="Times New Roman, Times, serif" color="#000000"><?php echo $row_n['hubungan']; ?>
            ...
            <div align="center"></div></td>
           <td><div align="center"><font size="3" face="Times New Roman, Times, serif" color="#000000"><?php echo $angka; ?></div></td>
          <td><div align="center"><font size="3" face="Times New Roman, Times, serif" color="#000000"><?php echo $huruf; ?></div></td>
