...
$sql = "SELECT * FROM peserta WHERE id = ".$_GET['id'];
...
<tr>
    <td class="style3">
    <form action=update_peserta.php method="POST" name="formedit" id="formedit" enctype="multipart/form-data">
    <input name="id" type="hidden" value="<?php echo $row['id'];?>">
      <table width="709" border="1" align="center">
        <tr>
          ...
          <td><input name="first_name" type="text" size="70" id="firsts_name" value="<?php echo $row['first_name'];?>"></td>
        </tr>
	<tr>
