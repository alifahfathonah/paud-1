...
<tr >
    <td  height="25" colspan="8" valign="middle"><font size="3" face="Times New Roman, Times, serif" color="#000000"><br><div align="center"><strong>Edit Visi</strong></div><br></td>
  </tr>
<tr>
    <td class="style3">
    <form action=update_visi.php method="POST" name="formedit" id="formedit">
